...
namespace SmsService
{
    ...
    {
        public static string myCompanyName = "GS Communications";
        ...
        //dem0 bps
        public static string User = "36";
        public static string SubUser = "59";
        public static string fYear = "2014";



        //---------  Get Permissions ------------------------

        public static string GetUserWhereCondition()
        {
            return " WHERE 1=1 AND UserID = " + User ;
        }

        public static string GetUserWhereCondition(string tbl)
        {

            return " WHERE 1=1 AND " + tbl + ".UserID = " + User + " AND " + tbl + ".FYear =  " + fYear;
        }

        public string GetUserInsertQry()
        {
            string insertValuesQry = "";
            insertValuesQry = User + ", " + SubUser+ ", " + fYear;
            return insertValuesQry;
        }


        public string GetUserUpdateQry()
        {
            string udateQry = "";
            udateQry = " UserId = " + User + ", SubuserId=" + SubUser + ", FYear = " + fYear;
            return udateQry;
        }
        ...
        public static string GetUserWhereCondition(string UserID, string fYear)
        {
            return " WHERE 1=1 AND UserID = " + UserID + " AND FYear =  " + fYear;
        }

        public static string GetUserWhereCondition(string UserID, string fYear, string tbl)
        {

            return " WHERE 1=1 AND " + tbl + ".UserID = " + UserID + " AND " + tbl + ".FYear =  " + fYear;
        }

        //public string GetUserInsertQry(string UserID, string fYear, string SubuserId)
        //{
        //    string insertValuesQry = "";
        //    insertValuesQry = Util_BLL.UserID + ", " + Util_BLL.SubUser.SubuserId + ", " + usr.fYear;
        //    return insertValuesQry;
        //}
        ...
        public int GetYearInt(DateTime theDate)
        {
            int theMonth = 1;
            theMonth = CheckNullInt(theDate.ToString("YYYY"));
            return theMonth;
        }

        public int GetDayInt(DateTime theDate)
        {
            int theMonth = 1;
            theMonth = CheckNullInt(theDate.ToString("DD"));
            return theMonth;
        }

        public int GetMonthInt(DateTime theDate)
        {
            int theMonth = 1;
            theMonth = CheckNullInt(theDate.ToString("MM"));
            return theMonth;
        }
