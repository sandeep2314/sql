              ...
              if(Util_BLL.IsStock==0) // iCollegeManager
                {
                  ...
                  // GuruNanak
                    if (Util_BLL.User.UserName.StartsWith("Shri"))
                    {


                        sub_menu = new MenuItem("Report Card (Class 1-8)", "940");
                        sub_menu.NavigateUrl = "~/Master/ReportCardOakWood.aspx?whichClass=G_1";
                        menu_trn.ChildItems.Add(sub_menu);

                        sub_menu = new MenuItem("Report Card (Class 9)", "949");
                        sub_menu.NavigateUrl = "~/Master/ReportCardOakWood.aspx?whichClass=G_9";
                        menu_trn.ChildItems.Add(sub_menu);

                        sub_menu = new MenuItem("Report Card (Class 11)", "9411");
                        sub_menu.NavigateUrl = "~/Master/ReportCardOakWood.aspx?whichClass=G_11";
                        menu_trn.ChildItems.Add(sub_menu);
                    }
                  ...
                  // BPS
                    ...
                    {
                        sub_menu = new MenuItem("Report Card ", "940");
                        sub_menu.NavigateUrl = "~/Master/ReportCardOakWood.aspx?whichClass=BPS_0";
                        menu_trn.ChildItems.Add(sub_menu);
                    ...
                    // Oak Wood
                    if (Util_BLL.User.UserName.StartsWith("Oak"))
                    {
                        sub_menu = new MenuItem("Report Card(1-8) ", "940");
                        sub_menu.NavigateUrl = "~/Master/ReportCardOakWood.aspx?whichClass=OK_0";
                        menu_trn.ChildItems.Add(sub_menu);

                        sub_menu = new MenuItem("Report Card(Nur-UKG) ", "950");
                        sub_menu.NavigateUrl = "~/Master/ReportCardOakWood.aspx?whichClass=OK_N";
                        menu_trn.ChildItems.Add(sub_menu);
                    }
                    ...
                    {
                        sub_menu = new MenuItem("Report Card (Class Nur-UKG)", "930");
                        sub_menu.NavigateUrl = "~/Master/ReportCardOakWood.aspx?whichClass=DPS_N";
                        menu_trn.ChildItems.Add(sub_menu);

                        sub_menu = new MenuItem("Report Card (Class 1-5)", "940");
                        sub_menu.NavigateUrl = "~/Master/ReportCardOakWood.aspx?whichClass=DPS_15";
                        menu_trn.ChildItems.Add(sub_menu);

                        sub_menu = new MenuItem("Report Card (Class 6-9)", "940");
                        sub_menu.NavigateUrl = "~/Master/ReportCardOakWood.aspx?whichClass=DPS_57";
                        menu_trn.ChildItems.Add(sub_menu);
