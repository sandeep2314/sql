...
namespace AccountingSoftware.BLL
{
    public class BPSBll
    {
        ...
        public class ReportCardCBSEEntity
        {
            ...
            public string PT_1_2_best { get; set; }
            public string PT_3_4_best { get; set; }
        ...
        public decimal GetTotal(ReportCardCBSEEntity rc, bool isHalfYearly, bool isMM)
        {
            ...
            else if (Util_BLL.User.UserName.StartsWith("Shri"))
            {
                return GetTotal_Guru(rc, isHalfYearly, isMM);
            }
            else if (Util_BLL.User.UserName.StartsWith("Oakwood"))
            {
                return GetTotal_Oak(rc, isHalfYearly, isMM);
            }
        ...
        public decimal GetOverAllMarks_LA(DataTable dt, bool isMM, bool isHalfYearly)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                is9 = theClass.Equals("IX A") || theClass.Equals("IX B") || theClass.Equals("IX C") ;
        ...
        public decimal GetOverAllMarks(DataTable dt, bool isMM, bool isHalfYearly)
        {
            ...
            {
                return GetOverAllMarks_Guru(dt, isMM, isHalfYearly);
            }
            else if (Util_BLL.User.UserName.StartsWith("Oakwood"))
            {
                return GetOverAllMarks_Oak(dt, isMM, isHalfYearly);
            }
        ...
        public List<ReportCardCBSEEntity> GetReportCardCBSE_BPS(int studentId)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                reportCard.PT_1_2_best = BestOfTwo(reportCard.PT1, reportCard.PT2);
                reportCard.PT_3_4_best = BestOfTwo(reportCard.PT3, reportCard.PT4);
...
////////////////////////////////Total Result
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                else
                {
                    ...
                    else if (isNur)
                    {
                        ...
                        overallMarks += CheckMedicalOrAbsent(util.CheckNullDecimal(dr["PT48_MM"]), false)
                                   + CheckMedicalOrAbsent(util.CheckNullDecimal(dr["PT49_MM"]), false)

                                   + CheckMedicalOrAbsent(util.CheckNullDecimal(dr["PT50_MM"]), false)
                                   + CheckMedicalOrAbsent(util.CheckNullDecimal(dr["PT51_MM"]), false);
                    }
        ...
        // Guru Nanak
        public decimal GetTotal_Guru(ReportCardCBSEEntity rc, bool isHalfYearly, bool isMM)
        {
            decimal first_Term_total = 0;
            decimal second_Term_total = 0;
            decimal total = 0;
        ...
        public decimal GetOverAllMarks_Guru(DataTable dt, bool isMM, bool isHalfYearly)
        {
            decimal overallMarks = 0;
        ...
        // END
        // Oak Wood
        public decimal GetTotal_Oak(ReportCardCBSEEntity rc, bool isHalfYearly, bool isMM)
        {
            decimal first_Term_total = 0;
            decimal second_Term_total = 0;
            decimal total = 0;

            string theClass = rc.ClassName;

            bool isNur = false;
            isNur = (theClass.StartsWith("Nursery") || theClass.StartsWith("LKG") || theClass.StartsWith("UKG") );
            ...
            else // Second Term
            {
                ...
                if (!isMM)
                {
                    ...
                    else
                    {
                        second_Term_total =
                                         CheckMedicalOrAbsent(util.CheckNullDecimal(rc.PT3), isMM)
                                         + CheckMedicalOrAbsent(util.CheckNullDecimal(rc.PT4), isMM)
                                         + CheckMedicalOrAbsent(util.CheckNullDecimal(rc.NoteBook2), isMM)
                                         + CheckMedicalOrAbsent(util.CheckNullDecimal(rc.SEA2), isMM)
                                         + CheckMedicalOrAbsent(util.CheckNullDecimal(rc.Yearly), isMM);
                ...
                else
                {
                    ...
                    else
                    {
                        second_Term_total =
                                        CheckMedicalOrAbsent(util.CheckNullDecimal(rc.PT3_MM), isMM)
                                        + CheckMedicalOrAbsent(util.CheckNullDecimal(rc.PT4_MM), isMM)
                                        + CheckMedicalOrAbsent(util.CheckNullDecimal(rc.NoteBook2_MM), isMM)
                                        + CheckMedicalOrAbsent(util.CheckNullDecimal(rc.SEA2_MM), isMM)
                                        + CheckMedicalOrAbsent(util.CheckNullDecimal(rc.Yearly_MM), isMM);
                    }
        ...
        public decimal GetOverAllMarks_Oak(DataTable dt, bool isMM, bool isHalfYearly)
        {
            decimal overallMarks = 0;
            string theClass = "";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                if (!isMM)
                {
                    ...
                    else
                    {
                        ...
                        overallMarks += CheckMedicalOrAbsent(util.CheckNullDecimal(dr["PerTest1"]), false)
                                        ...
                                        + CheckMedicalOrAbsent(util.CheckNullDecimal(dr["PT3"]), false)
                                        + CheckMedicalOrAbsent(util.CheckNullDecimal(dr["PT4"]), false)
                                        + CheckMedicalOrAbsent(util.CheckNullDecimal(dr["NoteBook2"]), false)
                                        + CheckMedicalOrAbsent(util.CheckNullDecimal(dr["SEA2"]), false)
                                        + CheckMedicalOrAbsent(util.CheckNullDecimal(dr["Yearly"]), false);
                    }
                ...
                else
                {
                    ...
                    {
                        overallMarks += 
                                     CheckMedicalOrAbsent(util.CheckNullDecimal(dr["PT25_MM"]), false)
                                     + CheckMedicalOrAbsent(util.CheckNullDecimal(dr["PT26_MM"]), false)
                                     + CheckMedicalOrAbsent(util.CheckNullDecimal(dr["PT20_MM"]), false)
                    ...
                    else
                    {
                        ...
                        overallMarks += CheckMedicalOrAbsent(util.CheckNullDecimal(dr["PerTest1_MM"]), false)
                                        ...
                                        + CheckMedicalOrAbsent(util.CheckNullDecimal(dr["PT3_MM"]), false)
                                        + CheckMedicalOrAbsent(util.CheckNullDecimal(dr["PT4_MM"]), false)
                                        + CheckMedicalOrAbsent(util.CheckNullDecimal(dr["NoteBook2_MM"]), false)
                                        + CheckMedicalOrAbsent(util.CheckNullDecimal(dr["SEA2_MM"]), false)
                                        + CheckMedicalOrAbsent(util.CheckNullDecimal(dr["Yearly_MM"]), false);
                    }
